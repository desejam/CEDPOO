        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                                 ...
                                 <form action="paciente_up.php" method="POST">
            <div class="row mb-3">
                <div class="col-sm-6">
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    <input class="form-control" id="diagnostico" name="diagnostico" rows="4"></input>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    <input type="number" class="form-control" id="mensalidade" name="mensalidade" step="0.01" required>
                </div>
                <div class="col-sm-6">
                    <label for="pagamentos" class="form-label">Pagamentos:</label>
                    <input class="form-control" id="pagamentos" name="pagamentos" rows="2"></input>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-sm-6">
                    ...
                    <input class="form-control" id="consultas" name="consultas" rows="4"></input>
                </div>
                <div class="col-sm-6">
                    <label for="relatorio" class="form-label">Relatório:</label>
                    <input class="form-control" id="relatorio" name="relatorio" rows="4"></input>
                </div>
            </div>
